import {Box, Typography, FormControl, FormHelperText, TextField, TextareaAutosize, Stack, Select, MenuItem, Button, borderRadius, fontSize, color}from '@pankod/refine-mui';
      ...
      <form style={{marginTop:'20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px'}} onSubmit={handleSubmit(onFinishHandler)}>
       ...
       <FormControl>
        ...
        <TextareaAutosize
          ...
          color="info"
          style={{width: '100%', background: 'transparent', fontSize: "16px", borderColor:'rgba(0,0,0,0.23)', borderRadius: 7, padding: 12 , color:'#919191'}}
